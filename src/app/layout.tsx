...
export const metadata: Metadata = {
  ...
  description: "Leading real estate development company specializing in luxury residential and commercial properties. Investment opportunities from $500k. 15+ years of excellence.",
  keywords: "real estate development, luxury properties, commercial development, residential investment, property development, real estate investment",
  metadataBase: new URL("https://heritageproperties.com"),
  alternates: {
    canonical: "https://heritageproperties.com"
  },
  openGraph: {
    title: "Heritage Properties - Premium Real Estate Development",
    description: "Leading real estate development company specializing in luxury residential and commercial properties. Investment opportunities available.",
